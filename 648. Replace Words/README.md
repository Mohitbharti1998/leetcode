...
class Solution {
    ...
    public String getShortWord(Set<String> d, String w) {
    ...
    // For optimization please use Trie data structure instead of HashSet
}
```
